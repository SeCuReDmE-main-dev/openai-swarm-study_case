...
- [`context_continuity_packet`](examples/context_continuity_packet): Phase 1 recipe showing optional app-layer context continuity across separate runs without modifying Swarm runtime internals.
